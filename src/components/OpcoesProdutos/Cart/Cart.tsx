...
export default function Cart() {
  const { itens, removerItem, alterarQuantidade, limparCarrinho, totalItens } = useCart();
      ...
      {aberto && (
        <div className={styles.painel}>
          <div className={styles.cabecalho}>
            ...
            <button className={styles.fechar} onClick={() => setAberto(false)}>✕</button>
          </div>
              ...
              <ul className={styles.lista}>
                {itens.map((item) => (
                  <li key={item.id} className={styles.item}>
                    <img src={item.imagem} alt={item.nome} className={styles.thumb} />
